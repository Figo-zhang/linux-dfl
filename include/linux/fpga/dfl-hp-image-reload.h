...
static inline struct dfl_image_reload *to_dfl_trigger_reload(struct dfl_image_trigger *trigger)
{
	return container_of(trigger, struct dfl_image_reload, trigger);
}
