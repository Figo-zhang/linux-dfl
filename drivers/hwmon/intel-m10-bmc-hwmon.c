...
static const struct m10bmc_sdata pmcibmc_temp_tbl[] = {
	...
	{ 0x5e8, 0x5ec, 0x5f0, 0x5c0, 0x0, 500, "FPGA Core Temperature [Remote]" },
};

static const struct m10bmc_sdata pmcibmc_in_tbl[] = {
	{ 0x5c4, 0x0, 0x0, 0x0, 0x0, 1, "Inlet 12V PCIe Rail Voltage" },
...
static const struct hwmon_channel_info *pmcibmc_hinfo[] = {
	HWMON_CHANNEL_INFO(temp,
			...
			HWMON_T_INPUT | HWMON_T_MAX | HWMON_T_CRIT | HWMON_T_LABEL,
			HWMON_T_INPUT | HWMON_T_MAX | HWMON_T_CRIT | HWMON_T_LABEL,
			HWMON_T_INPUT | HWMON_T_MAX | HWMON_T_CRIT | HWMON_T_CRIT_HYST |
			HWMON_T_LABEL,
			HWMON_T_INPUT | HWMON_T_MAX | HWMON_T_CRIT | HWMON_T_CRIT_HYST |
			HWMON_T_LABEL,
			HWMON_T_INPUT | HWMON_T_MAX | HWMON_T_CRIT | HWMON_T_CRIT_HYST |
