...
EXPORT_SYMBOL_GPL(pciehp_power_on_slot);
...
EXPORT_SYMBOL_GPL(pciehp_power_off_slot);
...
EXPORT_SYMBOL_GPL(pcie_shutdown_notification);
...
EXPORT_SYMBOL_GPL(pciehp_release_ctrl);
